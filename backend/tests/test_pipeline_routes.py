...
class TestSSEStreaming:
    ...
    async def test_sse_format_and_ordering(self, mock_run, client):
        ...
        events_to_emit = [
            ...
            {"type": "tool_start", "tool": "parse_pa_request", "input": {}, "tool_use_id": "tu1", "step_index": 0},
            {"type": "tool_result", "tool": "parse_pa_request", "output": {"rows": 100}, "source": "live", "tool_use_id": "tu1", "step_index": 0},
